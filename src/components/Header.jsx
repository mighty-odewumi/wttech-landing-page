    ...
    <>
      <header className="pt-6 pb-6 px-6 flex justify-between items-center md:mx-20 md:pt-0 md:pb-0 md:mt-[-30px] md:px-0 lg:mx-[140px]">
        <Link to="/" className="flex justify-center items-center gap-2  ">
          ...
          <h1 className="text-2xl text-primarygreen uppercase tracking-widest">
            Wttech
          </h1>
        </Link>
          ...
          >
            ...
            <div className="flex flex-col py-10 md:flex-row md:py-10 md:gap-8 md:font-light md:text-sm">
              ...
              <NavLink
                ...
                className="hover:border hover:font-bold py-4 md:hover:border-none md:hover:text-softred-100 transition-all md:font-semibold md:text-white"
                to="/"
              >
                Home
              </NavLink>
              ...
              <NavLink
                ...
                className="hover:border hover:font-bold py-4 md:hover:border-none md:hover:text-softred-100 md:font-semibold transition-all md:text-white"
                to="/about-us"
              >
                About Us
              </NavLink>
              ...
              <NavLink
                ...
                className="hover:border hover:font-bold py-4 md:font-bold md:bg-softred-100 md:t ext-black md:px-6 md:rounded-md md:hover:border-2 md:hover:border-softred-100 md:hover:bg-white md:hover:text-softred-100 md:transition-all md:text-white"
                to="/login"
              >
                Login
              </NavLink>
